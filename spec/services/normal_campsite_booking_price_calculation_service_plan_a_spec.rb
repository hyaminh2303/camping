...
RSpec.describe CampsiteBookingPriceCalculationService, type: :service do
  before(:each) do
    ...
    campsite_plan_fee.normal_child_and_pet_fees.create(fee_value: 7000,
      child_and_pet_setting: @child_and_pet_setting_4)
    campsite_plan_fee.normal_child_and_pet_fees.create(fee_value: 6000,
  ...
  describe "normal campsite plan fee - Plan A" do
