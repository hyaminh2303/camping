...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "g_camp_production"
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain:               'sazae.com.au',
    port:                 587,
    user_name:            Rails.application.credentials[:ses_username],
  ...
  CarrierWave.configure do |config|
    ...
    config.fog_directory  = ENV["aws_bucket_name"]                  # required, it is bucket name
  ...
  config.before_initialize do
    ...
    config.middleware.use ExceptionNotification::Rack, email: {
      email_prefix: "[G'Camp Production] ",
      sender_address: Settings.exception_notification_sender,
