...
RSpec.describe CampsiteBookingPriceCalculationService, type: :service do
  before(:each) do
    ...
    @campsite.update(
      ...
      number_of_people_pet_included: 2
    )
  ...
  describe "normal campsite plan fee - Plan C" do
    context "checks to both checkbox weekday and weekend" do
      # total entrance for 2 nights = (800*2+700)*2 = 4600
      # weekday(t6) = 10001+8009 = 18010
      # weekend(t7) = 20001+9009 = 29010
      # total = 4600+18010+29010 = 51620
      it "calculates price when 2 Adults + 1 (a)Child" do
        ...
        expect(price).to eq(51620)
      end

      # total entrance for 2 nights = (800+600+500)*2 = 3800
      # weekday(t6) = 10001+8007 = 18008
      # weekend(t7) = 20001+9007 = 29008
      # total = 3800+18008+29008 = 50816
      it "calculates price when 1 Adults + 1 (b) Child + 1 (c)Child" do
        ...
        service = CampsiteBookingPriceCalculationService.new(campsite_booking)
        price = service.calculate
        expect(price).to eq(50816)
      end

      # total entrance for 2 nights = (800+700*2+400+0)*2 = 5200
      # weekday(t6) = 10001+8009+8006+8005 = 34021
      # weekend(t7) = 20001+9009+9006+9005 = 47021
      # total = 5200+34021+47021 = 86242
      it "calculates price when 1 Adult + 2 (a)Child + 1(d)Child + 1 (e) Child" do
        ...
        service = CampsiteBookingPriceCalculationService.new(campsite_booking)
        price = service.calculate
        expect(price).to eq(86242)
      end

      # total entrance for 2 nights = (800+500)*2 = 2600
      # weekday(t6) = 10001 = 10001
      # weekend(t7) = 20001 = 20001
      # total = 2600+10001+20001 = 32602
      it "calculates price when 1 Adult + 1 Pet" do
        ...
        service = CampsiteBookingPriceCalculationService.new(campsite_booking)
        price = service.calculate
        expect(price).to eq(32602)
      end

      # total entrance for 2 nights = (800*5+500*2+0*2)*2 = 10000
      # weekday(t6) = 10001*2+10000+8007*2+8005*2 = 62026
      # weekend(t7) = 20001*2+20000+9007*2+9005*2 = 96026
      # total = 10000+62026+96026 = 168052
    ...
    context "only checked to checkbox classification_day_setting_weekday" do
      ...
      # week end: => no check => use price in campsite campsite
      # weekend(t7) = 30001+0 = 30001
      # total = 4600+18010+30001 = 52611
      ...
      it "calculates price when 2 Adults + 1 (a)Child" do
        ...
        service = CampsiteBookingPriceCalculationService.new(campsite_booking)
        price = service.calculate
        expect(price).to eq(52611)
      end

      # total entrance for 2 nights = (800+600+500)*2 = 3800
      # weekday(t6) = 10001+8007 = 18008
      # weekend(t7) = 20001+0 = 20001
      # total = 3800+18008+20001 = 50816
      it "calculates price when 1 Adults + 1 (b) Child + 1 (c)Child" do
        @campsite_plan_fee.classification_day_settings.destroy(@classification_day_setting_weekend)
